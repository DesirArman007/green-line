...
export default function ContactEnquiriesClient() {
  ...
  const updateStatus = async (id: string, status: string) => {
    ...
    if (!error) {
      await logAuditAction('UPDATE', 'contact_enquiries', id, user?.email, { status });
      fetchEnquiries();
    }
  };
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <p>Leads from the general "Contact Us" form</p>
      </div>
